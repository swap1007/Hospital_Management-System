...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon"
    href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdRoMCJDW_zv-x3a8CnKvRGVONz67yJqoNcw&usqp=CAU" />
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    ...
    <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> LIFE CARE HOSPITAL </a>
...
<body style="padding-top:50px;">
  <div class="container-fluid" style="margin-top:50px;">
    <h3 style="margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"> WELCOME RECEPTIONIST
    </h3>
    <div class="row">
